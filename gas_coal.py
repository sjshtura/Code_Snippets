...
def mean_gas_price(customer_type):

    if(customer_type == 0):
        #erdgas Hausholds
        haushalt_prices_without_VAT = pd.read_excel(r'Energiepreisentwicklung.xlsx',sheet_name='5.3.2  Erdgas-€-Haushalte', skiprows = 5, nrows = 26, index_col = 0)
        ...
        #erdgas Industrie
        industrie_prices_without_VAT = pd.read_excel(r'Energiepreisentwicklung.xlsx',sheet_name='5.3.3  Erdgas-€-Unternehmen', skiprows = 5, nrows = 26, index_col = 0)
...
def mean_coal_price(coal_type):

    if(coal_type == 0): 
        #Braunkohle prices

        Braunkohle_prices_without_VAT = pd.read_excel(r'Energiepreisentwicklung.xlsx',sheet_name='5.1 Steinkohle und Braunkohle', skiprows = 27, nrows = 16, usecols = "A,N")
        ...
        Steinkohle_prices_without_VAT = pd.read_excel(r'Energiepreisentwicklung.xlsx',sheet_name='5.1 Steinkohle und Braunkohle', skiprows = 6, nrows = 16, usecols = "A,N")
...
# Enter Customer type = 0 (Households) or Customer type = 1 (Industry)
mean_gas_price(0)
